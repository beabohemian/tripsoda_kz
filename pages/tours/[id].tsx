...
const tours = [
    ...
    },
    {
        ...
        description: '쾌적하고 전문적인 실내 스튜디오에서 화려한 에스닉 의상을 입고 특별한 화보를 남겨보세요. 날씨에 구애받지 않고 언제든 완벽한 사진을 찍을 수 있습니다.',
        schedule: [
            { time: '준비', title: '의상 피팅 및 컨셉 논의', desc: '카자흐 전통 의상(샤판 등)을 입고, 전문 포토그래퍼와 스튜디오 배경 및 컨셉을 맞춥니다.' },
            { time: '본 촬영', title: '전문 스튜디오 스냅 촬영', desc: '전문 조명과 세팅이 완비된 스튜디오에서 영화 같은 화보 촬영이 진행됩니다.', image: '/images/tour_kazakh_snap.png' },
