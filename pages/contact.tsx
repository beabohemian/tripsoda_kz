  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-20">
        <h1 className="text-3xl md:text-4xl font-bold text-center text-tripsoda-textMain mb-8 md:mb-12">
          문의하기
        </h1>
...
=======
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-tripsoda-textMain mb-4">
                연락처 및 위치
              </h2>
...
>>>>>>> 09fd3049bb511e1df07a3519c3775ad274d2220c
            </div >
...
<form onSubmit={handleSubmit} className="space-y-8">
  {/* Basic Info */}
  <div>
    <h3 className="text-lg font-bold text-tripsoda-main mb-4 border-b pb-2">
      1. 기본 정보
    </h3>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
