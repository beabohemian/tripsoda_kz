    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
            ...
            <a
                ...
                className="group flex items-center justify-center gap-2 px-5 py-3 bg-[#FEE500] text-[#3A1D1D] rounded-full shadow-lg hover:bg-[#F4DC00] hover:-translate-y-1 transition-all duration-300"
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center gap-2 px-5 py-3 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#128C7E] hover:-translate-y-1 transition-all duration-300"
