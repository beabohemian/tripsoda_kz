            ...
            >
                ...
                <nav className="hidden md:flex space-x-8">
                    {navLinks.map((link) => (
                        <Link key={link.name} href={link.href}>
                            <a className={`transition-colors font-bold hover:text-tripsoda-main ${scrolled ? 'text-sm text-gray-800' : 'text-tripsoda-textMain'}`}>
                                {link.name}
                            </a>
                        </Link>
                    ))}
                ...
                <div className="flex items-center md:hidden">
                    <button
                        ...
                        className={`p-2 focus:outline-none transition-colors text-tripsoda-textMain hover:text-tripsoda-main`}
                    >
